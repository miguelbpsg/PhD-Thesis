...
//Método Inicializacion
		final Initialization[] initMethods = {new RandomInitialization()};
...
//Método Mutación
		final Mutation[] mutationMethods = {new ExhaustiveMutation()};
...
//BOTONES
	...
	public void updateResult(Individual c) {
		...
		pResult.add(lArbol, constraints);
		lArbol.revalidate();
		lFitness.revalidate();
		pResult.revalidate();
		pRight.add(pResult, BorderLayout.SOUTH);
